...
$bg  = ! empty( $attributes['bgColor'] ) ? $attributes['bgColor'] : get_theme_mod( 'flairltd_primary_color', '#1e3a8a' );
$bg2 = ! empty( $attributes['bgColor2'] ) ? $attributes['bgColor2'] : get_theme_mod( 'flairltd_bright_color', '#2563eb' );
