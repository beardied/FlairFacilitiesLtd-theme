...
<div style="position:relative;border-radius:16px;overflow:hidden">
    ...
    <div style="position:absolute;bottom:24px;left:24px;right:24px;border-radius:14px;padding:24px;display:flex;gap:40px;background:rgba(10,22,40,0.7);backdrop-filter:blur(10px)">
        <div>
