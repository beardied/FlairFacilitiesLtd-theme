<?php
$image_id = ! empty( $attributes['imageId'] ) ? intval( $attributes['imageId'] ) : 0;
...
if ( $image_id ) {
    ...
    $img_html = '<img src="' . esc_url( $url ) . '" alt="' . esc_attr( $alt ) . '" style="width:100%;height:500px;object-fit:cover" class="skip-lazy" loading="eager" decoding="async">';
}
